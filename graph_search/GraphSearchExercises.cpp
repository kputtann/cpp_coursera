...
int GridGraph::countEdges() const {
  ...
  // TODO: Your code here!
  // =======================================================================
    for (const auto & curmap_node_to_adjnodes : adjacencyMap) {
        // std::cout << "!!!! KP: Cur node" << curmap_node_to_adjnodes.first << std::endl;
        // std::cout << "!!!! KP: Adjancency size " << curmap_node_to_adjnodes.second.size() << std::endl;
        numEdges += curmap_node_to_adjnodes.second.size();
    }
    numEdges /= 2;
  return numEdges;
}
...
void GridGraph::removePoint(const IntPair& p1) {
  ...
  // TODO: Your code here!
  // =======================================================================
    for (const auto & curnode: originalNeighbors) {
            adjacencyMap[curnode].erase(p1);
        }
